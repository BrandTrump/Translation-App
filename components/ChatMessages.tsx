...
function ChatMessages({ chatId, initialMessages, session }: ChatMessagesProps) {
  ...
  return (
    <div className="p-5">
      {!loading && messages?.length === 0 && (
        <div className="flex flex-col justify-start text-center items-center p-20 rounded-xl space-y-2 bg-indigo-400 text-white font-extralight">
